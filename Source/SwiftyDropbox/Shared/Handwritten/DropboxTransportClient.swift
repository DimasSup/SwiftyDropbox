...
open class DropboxTransportClient {
	...
	public convenience init(accessToken: String, selectUser: String? = nil, pathRoot: Common.PathRoot? = nil,customSessionManager:SessionManager? = nil) {
		self.init(accessToken: accessToken, baseHosts: nil, userAgent: nil, selectUser: selectUser, pathRoot: pathRoot,backgroundSession:customSessionManager)
	}
	...
	public init(accessToken: String,
		...
		let backgroundManager = { () -> SessionManager in
			if let customSession = backgroundSession{
